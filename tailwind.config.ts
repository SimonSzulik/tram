  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Custom colors for compiler visualization
        editor: {
          DEFAULT: "hsl(var(--editor-bg))",
          foreground: "hsl(var(--editor-text))",
          line: "hsl(var(--editor-line-number))",
          highlight: "hsl(var(--editor-highlight))",
        },
        execution: {
          DEFAULT: "hsl(var(--execution-current))",
          bg: "hsl(var(--execution-current-bg))",
        },
        stack: {
          push: "hsl(var(--stack-push))",
          pop: "hsl(var(--stack-pop))",
